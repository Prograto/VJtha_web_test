...
if (title === "mains") {
  ...
  scriptUrl = `https://script.google.com/macros/s/AKfycbzc_wi0pCF7396TA32clmxkJs9GyBnxr7rUUlh60h-Ld_5m40B4U9kptnEjbQZCxQctAA/exec?action=get_questions&sheet=${encodeURIComponent(sheetName)}`;
  marksUrl = "https://script.google.com/macros/s/AKfycbzxgA6pKunoD8A6tqTcpHaUhTZvdKH2u-9XVe24XQjysoz609T_okyHMjjaN7ZlGNrHEg/exec";
...
function submitExam() {
  ...
  showSubmitCard(75, score, correct, wrong);
  submitMarks(score);
}
